(function () {
  ...
  var views = [
    { dim:'Origin',  data:[['Direct',40],['Organic',35],['Newsletter',11],['Paid',9],['Social',5]] },
    { dim:'Campaigns', data:[['Search Ads',45],['LinkedIn Ads',25],['Newsletter',15],['Meta-Ads',10],['QR-Sticker',5]] },
    { dim:'Cantons',   data:[['ZH',34],['BE',26],['BS',20],['LU',12],['Other',8]] }
  ];
