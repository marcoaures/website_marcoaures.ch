(function () {
  ...
  var lines = [
    ...
    [],
    [{cls:'rb-comment', text:'# Warenkorbseite ausschliessen'}],
    [{cls:'rb-key', text:'Disallow: '},{cls:'rb-val', text:'/cart/'}],
    [{cls:'rb-comment', text:'# Gefilterte Übersicht ausschliessen'}],
    [{cls:'rb-key', text:'Disallow: '},{cls:'rb-val', text:'/*?filter='}],
    [],
    [{cls:'rb-key', text:'Sitemap: '},{cls:'rb-val', text:'https://deineseite.ch/sitemap.xml'}]
  ];
