document.addEventListener('DOMContentLoaded', function () {
	...
	function updateResults() {
		...
		if (medCpaInput)  medCpaInput.value  = formatCHF(medCpa)  + ' (erwartbar)';
		if (lowCpaInput)  lowCpaInput.value  = formatCHF(lowCpa)  + ' (optimistisch)';
		if (highCpaInput) highCpaInput.value = formatCHF(highCpa) + ' (pessimistisch)';
		...
		if (minBudgetInput)  minBudgetInput.value  = formatCHF(minBudget)  + ' pro Tag';
		if (lowBudgetInput)  lowBudgetInput.value  = formatCHF(lowBudget)  + ' pro Tag';
		if (normBudgetInput) normBudgetInput.value = formatCHF(normBudget) + ' pro Tag';
	}
